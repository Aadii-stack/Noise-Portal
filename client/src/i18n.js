...
const translations = {
  en: {
    ...
    heroBody: 'Citizens can submit anonymous reports for excessive honking, loud music, construction noise, and vehicle revving across Mumbai.',
  ...
  hi: {
    ...
    heroBody: 'नागरिक अत्यधिक हॉर्न, तेज संगीत, निर्माण शोर और वाहन रेविंग की अनाम रिपोर्ट जमा कर सकते हैं।',
